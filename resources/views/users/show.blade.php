    ...
    <div class="max-w-md mx-auto bg-white shadow-md rounded-md overflow-hidden">
        <div class="p-6 space-y-6 md:space-y-10">
            <div class="flex flex-col space-y-6 md:space-y-14">
                ...
                <div class="space-y-2 md:space-y-3">
                    <div class="flex items-center">
                        ...
                        <span id="email" class="w-2/3 text-gray-800 ml-2 text-sm md:text-base">{{ $user->email }}</span>
                    </div>
                    <div class="flex items-center">
                        <i class="fa-solid fa-cake-candles"></i>
                        <span id="birthday" class="w-2/3 text-gray-800 ml-3 text-sm md:text-base">{{ \Carbon\Carbon::parse($user->birthday)->format('d/m/Y') }}</span>
                    </div>
                </div>
            </div>
            <div class="bg-gray-100 p-4 rounded-lg">
                ...
                @else
                    <h2 class="text-lg font-semibold mb-2 text-sm md:text-base">
